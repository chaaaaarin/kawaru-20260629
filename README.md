...
📊 [スライド資料はこちら（slides.html）](https://chaaaaarin.github.io/kawaru-20260629/slides.html) | 📋 [1枚まとめ資料はこちら（onepager.html）](https://chaaaaarin.github.io/kawaru-20260629/onepager.html)

## 動画概要
OpenAI Codex を使っていてトークン（＝料金・レート制限）が増えがちな理由と、今日から使える節約テクニックを体系的に解説する回。「コンテキストを小さく保つ＝節約＆精度向上の一石二鳥」が核心メッセージ。Claude Code版と対比しながら、Codex固有の仕組みと節約術を整理する。
